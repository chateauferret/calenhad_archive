...
//! Constructor
CubicSplineFitter::CubicSplineFitter(): QwtSplineCurveFitter() {
}
...
\sa fitCurvePath()
*/
QPolygonF CubicSplineFitter::fitCurve (const QPolygonF &points) const {
...
double CubicSplineFitter::getY (const double& x, const QPolygonF& points) const {
